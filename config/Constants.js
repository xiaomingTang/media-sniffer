...
const cssModulePrefix = timestamp
...
const prefix = `
// ==UserScript==
// @timestamp    ${timestamp/* 这个参数用来确定你确实成功更新了脚本 */}
// @name         ${"多媒体搜猎" || packageJson.name || "tamperscript name"}
// @author       ${packageJson.author || "tamperscript author"}
// @version      ${packageJson.version || "1.0.0"}
// @description  ${packageJson.description || "tamperscript description"}
// @namespace    http://tampermonkey.net/${timestamp}
